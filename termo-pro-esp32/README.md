...
-Programs: * Program B (Basic): Pre-configured (Start: 21°C / Stop: 23°C).
...
This is the default screen. It displays the following layout: T: vv.v H: vv.v PN XX:XX DAY[N] D/N O/F
...
-EPG (Edit Program): * Select the program you wish to modify.
...
-ETM (Edit Time): * Modify Hour, Minute, and Day.
